...
class UEditorField(models.TextField):
    ...
    """
    def __init__(self,verbose_name=None, width=600, height=300, toolbars="full",imagePath="", filePath="", videoPath="", upload_settings={},settings={},command=None,event_handler=None ,**kwargs):
